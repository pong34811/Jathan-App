      ...
      <div className="container mt-5">
        <div className="card shadow-lg">
          <div className="card-header bg-primary text-white text-center">
            <h5 className="mb-0">🔔 Email Notify Settings</h5>
          </div>
            ...
            <div className="tab-content mt-3">
              {["board", "task"].map((category) => (
                ...
                >
                  ...
                  {[
                    {
                      key: `is_email_notify_create_${category}`,
                      label: "แจ้งเตือนเมื่อสร้าง",
                    },
                    {
                      key: `is_email_notify_update_${category}`,
                      label: "แจ้งเตือนเมื่ออัปเดต",
                    },
                    {
                      key: `is_email_notify_delete_${category}`,
